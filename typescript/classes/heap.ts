...
class Heap {
    ...
    bubbleUp(child_idx: number): void {
        ...
        let is_swap = this.mode === 'max' ? child_num > parent_num : parent_num > child_num;
...
export class MinBinaryHeap extends Heap {
    ...
    delete(num: number): void {
        ...
        this.values[del_l_child_idx] = del_l_child_num === large_num ? del_r_child_num : del_l_child_num;
        this.values
